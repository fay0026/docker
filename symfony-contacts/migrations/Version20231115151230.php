 ...
 */
final class Version20231115151230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, firstname VARCHAR(30) NOT NULL, lastname VARCHAR(40) NOT NULL, email VARCHAR(100) NOT NULL, phone VARCHAR(20) NOT NULL, INDEX IDX_4C62E63812469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
